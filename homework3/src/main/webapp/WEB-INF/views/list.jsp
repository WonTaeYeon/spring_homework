...
<c:forEach var="sjlist1" items="${sjlist2}">
			...
			<c:if test="${sjlist1.year=='2013'}">
				<c:if test="${sjlist1.semester=='1'}">
					<c:set var="weight20121" value="${weight20131+sjlist1.sjweight}" />
				</c:if>
			</c:if>
			<c:if test="${sjlist1.year=='2015'}">
				<c:if test="${sjlist1.semester=='2'}">
					<c:set var="weight20122" value="${weight20151+sjlist1.sjweight}" />
				</c:if>
			</c:if>
			<c:if test="${sjlist1.year=='2016'}">
				<c:if test="${sjlist1.semester=='1'}">
					<c:set var="weight20151" value="${weight20161+sjlist1.sjweight}" />
				</c:if>
				<c:if test="${sjlist1.semester=='2'}">
					<c:set var="weight20152" value="${weight20162+sjlist1.sjweight}" />
				</c:if>
			</c:if>
			<c:if test="${sjlist1.year=='2017'}">
				<c:if test="${sjlist1.semester=='1'}">
					<c:set var="weight20161" value="${weight20171+sjlist1.sjweight}" />
				</c:if>
	...
	<table border="1">
		...
		<tr align="center">
			...
			<td>1</td>
			<td>${weight20131}</td>
			<td><a href="${pageContext.request.contextPath}/view/2013/1">링크</a></td>
		</tr>
		...
		<tr align="center">
			...
			<td>1</td>
			<td>${weight20162}</td>
			<td><a href="${pageContext.request.contextPath}/view/2016/2">링크</a></td>
		</tr>
		<tr align="center">
			<td>2016</td>
			<td>1</td>
			<td>${weight20171}</td>
			<td><a href="${pageContext.request.contextPath}/view/2017/1">링크</a></td>
		</tr>
	</table>
</body>
</html>