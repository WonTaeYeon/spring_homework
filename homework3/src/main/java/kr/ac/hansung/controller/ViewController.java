...
public class ViewController {
	...
	public String Viewlist3(Model model) {
		List<Sjlist2> sjlist = listsService.getSjectweights1("2013");
		model.addAttribute("sjlist", sjlist);
		return "viewlist";
	}
	...
	public String Viewlist6(Model model) {
		List<Sjlist2> sjlist = listsService.getSjectweights1("2016");
		model.addAttribute("sjlist", sjlist);
		return "viewlist";
	}
	...
	public String Viewlist7(Model model) {
		List<Sjlist2> sjlist = listsService.getSjectweights1("2017");
		model.addAttribute("sjlist", sjlist);
		return "viewlist";
	}
}
